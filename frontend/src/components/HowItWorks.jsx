...
import { MessageSquare, Lock, Cpu, BadgeCheck } from 'lucide-react';

const STEPS = [
  { icon: MessageSquare, n: '01', t: 'Brief & Quote', d: 'Tell us your target & package. Instant encrypted quote on Telegram or in-app.' },
  { icon: Lock, n: '02', t: 'Secure Handshake', d: 'Payment routed through encrypted channels. Zero KYC, zero footprint.' },
  { icon: Cpu, n: '03', t: 'Manual Operation', d: 'Our operators execute manually. No bots, no shortcuts. Drip-feed available.' },
  { icon: BadgeCheck, n: '04', t: 'Guarantee & Refill', d: 'Up to 60-day refill warranty. If anything drops — we top it up. On the house.' },
];
