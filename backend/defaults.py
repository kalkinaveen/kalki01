...
DEFAULT_CONFIG = {
    ...
    "recovery": {
        ...
        "services": [
            ...
            {"id": "s_username", "name": "Username Claim (Dormant)", "issue_key": "username", "price_min": 9999, "price_max": 99999, "eta_min_days": 7, "eta_max_days": 30, "success_rate": 80, "bullets": ["Inactive handle takeover", "Premium 3–5 letter names", "Secure ownership transfer"], "active": True, "sort": 4},
            {"id": "s_verify", "name": "Blue Tick Verification", "issue_key": "verification", "price_min": 19999, "price_max": 49999, "eta_min_days": 7, "eta_max_days": 21, "success_rate": 75, "bullets": ["Identity + notability docs", "End-to-end submission", "Refund if rejected"], "active": True, "sort": 5},
            {"id": "s_password", "name": "Lost Password Recovery", "issue_key": "password", "price_min": 999, "price_max": 3999, "eta_min_days": 1, "eta_max_days": 3, "success_rate": 89, "bullets": ["Recovery without email access", "Phone-loss scenarios covered", "Fast turnaround"], "active": True, "sort": 6},
        ],
    },
}
